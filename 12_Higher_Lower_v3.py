...
def instructions():
    ...
    print(
        "- Enter a 'low' and 'high' number. The compute'r will randomly generate a 'secret' number between your two chosen numbers. It will use these numbers for all the rounds in agiven game."
    )
...
print()
rounds = int_check(" Rounds: ", 0, exit_code="") # checking for the number of rounds 
...
while keep_going == "yes":
  ...
  while guess != secret and guesses_left >= 1:
      guess = int_check("Guess: ", low, high, "xxx")  # replace this with function
